...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(160, 130);
    ...
    private static final Scalar
            lower_yellow_bounds  = new Scalar(68, 124, 124, 255),
            upper_yellow_bounds  = new Scalar(167, 117, 106, 255),
            lower_cyan_bounds    = new Scalar(35, 128, 128, 255),
            upper_cyan_bounds    = new Scalar(58, 128, 130, 255),
            lower_magenta_bounds = new Scalar(54, 134, 129, 255),
            upper_magenta_bounds = new Scalar(149, 155, 136, 255);
